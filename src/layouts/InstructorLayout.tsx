...
import { ClipboardList, UserPlus, User, LogOut } from 'lucide-react'
import logo from '/logo_TecMisantla-BzNub4Q9.png'

const navItems = [
  { to: '/instructor',               label: 'Mis Actividades', icon: ClipboardList, end: true },
  { to: '/instructor/inscripciones', label: 'Inscripciones',   icon: UserPlus },
  { to: '/instructor/perfil',        label: 'Mi Perfil',       icon: User },
]
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-56 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-100">
          ...
          <p className="text-xs text-red-500">Instructor</p>
          <button
